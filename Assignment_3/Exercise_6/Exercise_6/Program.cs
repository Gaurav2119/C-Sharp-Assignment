...
namespace ExtendedEquipmentInventory
{
    class Equipment
    {
        private string name;
    ...
    class ExtendedEquipmentInventory
    {
        ...
        static void createEquipment(List<Equipment> equipments)
        {
            ...
            else
            {
                ...
                if (!double.TryParse(Console.ReadLine(), out maintenanceCost))
                {
        ...
        static void deleteEquipment(List<Equipment> equipments)
        {
            if (equipments.Count > 0)
            {
                ...
                if (!int.TryParse(Console.ReadLine(), out selectedMobileEquipment))
                {
